...
class io_dzz extends io_api
{
    ...
    public function upload_by_content($fileContent, $path, $filename, $fid = '', $level = 0, $partinfo = array())
    {
        return self::upload($fileContent, $path, $filename, $fid, $level, $partinfo);
    }
     ...
     * @return string
     */
    public function upload($fileContent, $appid, $filename, $fid = '', $level = 0, $partinfo = array(), $ondup = 'newcopy')
    {
