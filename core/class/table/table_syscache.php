...
class table_syscache extends dzz_table
{
	...
	public function fetch($cachename = null, $force_from_db = false) {
	...
	public function insert($cachename, $data = null, $return_insert_id = false, $replace = false) {
		parent::insert(array(
			'cname' => $cachename,
	...
	public function update($cachename, $data = null, $unbuffered = false, $low_priority = false) {
		$this->insert($cachename, $data);
	}

	public function delete($cachenames = null, $unbuffered = false) {
